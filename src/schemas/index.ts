...
export const PropertySchema = z.object({
  ...
  mq: z.number().nonnegative('MQ non può essere negativo'),
  locali: z.string().min(1),
  citta: z.string().min(2),
  indirizzo: z.string().optional(),
  piano: z.string().optional(),
  bagni: z.number().int().min(1).max(10).nullable().optional(),
  classe_energetica: z.enum(['A4', 'A3', 'A2', 'A1', 'B', 'C', 'D', 'E', 'F', 'G', 'Esente']),
